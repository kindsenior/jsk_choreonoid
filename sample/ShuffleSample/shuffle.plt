...
b=0.5
c=5
plot contact u 1:3, contact u 1:12, wrench u 1:($4/1000), wrench u 1:($10/1000),input u 1:($13/1000)
...
replot input u 1:2,ref u 1:2, input u 1:($5/M) t "input dCMx",ref u 1:($5/M) t "ref dCMx", ref u 1:3,ref u 1:($6/M) t "ref dCMy", ref u 1:($8/10),ref u 1:($9/10),ref u 1:($10/100)#, ref u 1:4,ref u 1:($7/100)
replot wrench u 1:($2/1000+1.2), wrench u 1:($3/1000+1.2), wrench u 1:($8/1000-1.2), wrench u 1:($9/1000-1.2), wrenches u 1:($4/1000) t "rfz"
