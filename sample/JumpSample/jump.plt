...
replot wrench u 1:(-$6/$4)*copscale t "lCOPx", wrench u 1:(-$12/$10)*copscale t "rCOPx"
...
replot init u 1:4,pre u 1:4,init u 1:($7/100),pre u 1:($7/42.7*b), iee u 1:($7*b) t "init ldz", iee u 1:($4*c) t "init lz"
 # replot ee u 1:($4*c) t "ref lz", opt u 1:6 t "rleg time"
